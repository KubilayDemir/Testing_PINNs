...
data_directories = ["Train_On_PINNs_Loss/AH=0/", "Train_On_PINNs_Loss/AH=5e+4/",
                    "Train_On_Validation_Loss/AH=0/", "Train_On_Validation_Loss/AH=5e+4/"]
...
axs[0, 1].plot(training_steps, pd.Series(total_MSE_over_training).rolling(100).mean(), label=r"$\mathcal{L}_{total}$",
               linewidth=1.5, alpha=1.0, color="C0")
axs[0, 1].plot(training_steps, pd.Series(MSE_boundary_conditions_over_training).rolling(100).mean(),
               label=r"$\mathcal{L}_{BC}$", linewidth=1.5, alpha=1.0, color="C1")
...
axs[1, 0].plot(training_steps, MSE_boundary_conditions_over_training, linewidth=0.20, alpha=0.35, color="C1")
axs[1, 0].plot(training_steps, MSE_initial_conditions_over_training, linewidth=0.20, alpha=0.35, color="C2")
...
axs[1, 0].plot(training_steps, pd.Series(total_MSE_over_training).rolling(100).mean(), label=r"$\mathcal{L}_{total}$",
               linewidth=1.5, alpha=1.0, color="C0")
axs[1, 0].plot(training_steps, pd.Series(MSE_boundary_conditions_over_training).rolling(100).mean(),
               label=r"$\mathcal{L}_{BC}$", linewidth=1.5, alpha=1.0, color="C1")
axs[1, 0].plot(training_steps, pd.Series(MSE_initial_conditions_over_training).rolling(100).mean(),
               label=r"$\mathcal{L}_{IC}$", linewidth=1.5,
               alpha=1.0, color="C2")
...
line1 = axs[1, 1].plot(training_steps[0], pd.Series(total_MSE_over_training[0]),
               label=r"$\mathcal{L}_{total}$",
               linewidth=4, alpha=1.0, color="C0")
line2 = axs[1, 1].plot(training_steps[0], pd.Series(MSE_boundary_conditions_over_training[0]),
               label=r"$\mathcal{L}_{BC}$", linewidth=4, alpha=1.0, color="C1")
line3 = axs[1, 1].plot(training_steps[0], pd.Series(MSE_initial_conditions_over_training[0]),
               label=r"$\mathcal{L}_{IC}$", linewidth=4,
               alpha=1.0, color="C2")
line4 = axs[1, 1].plot(training_steps[0], pd.Series(MSE_symbolic_functions_over_training[0]),
               label=r"$\mathcal{L}_{PDE}$", linewidth=4,
               alpha=1.0, color="C3")
line5 = axs[1, 1].plot(training_steps[0], pd.Series(Relative_L2_Error_h_over_training[0]),
               label=r"$\mathcal{L}_{num,\zeta}$", linewidth=4,
               alpha=1.0, color="C4")
line6 = axs[1, 1].plot(training_steps[0], pd.Series(Relative_L2_Error_u_over_training[0]),
               label=r"$\mathcal{L}_{num,u}$", linewidth=4,
               alpha=1.0, color="C5")

axs[1, 1].plot(training_steps, total_MSE_over_training[0:1000100:100], linewidth=0.20, alpha=0.35, color="C0")
axs[1, 1].plot(training_steps, MSE_boundary_conditions_over_training[0:1000100:100], linewidth=0.20, alpha=0.35,
               color="C1")
axs[1, 1].plot(training_steps, MSE_initial_conditions_over_training[0:1000100:100], linewidth=0.20, alpha=0.35,
               color="C2")
axs[1, 1].plot(training_steps, MSE_symbolic_functions_over_training[0:1000100:100], linewidth=0.20, alpha=0.35,
               color="C3")
axs[1, 1].plot(training_steps, Relative_L2_Error_h_over_training[0:1000100:100], linewidth=0.20, alpha=0.35, color="C4")
axs[1, 1].plot(training_steps, Relative_L2_Error_u_over_training[0:1000100:100], linewidth=0.20, alpha=0.35, color="C5")

axs[1, 1].plot(training_steps, pd.Series(total_MSE_over_training[0:1000100:100]).rolling(100).mean(),
               label=r"$\mathcal{L}_{total}$",
               linewidth=1.5, alpha=1.0, color="C0")
axs[1, 1].plot(training_steps, pd.Series(MSE_boundary_conditions_over_training[0:1000100:100]).rolling(100).mean(),
               label=r"$\mathcal{L}_{BC}$", linewidth=1.5, alpha=1.0, color="C1")
axs[1, 1].plot(training_steps, pd.Series(MSE_initial_conditions_over_training[0:1000100:100]).rolling(100).mean(),
               label=r"$\mathcal{L}_{IC}$", linewidth=1.5,
               alpha=1.0, color="C2")
axs[1, 1].plot(training_steps, pd.Series(MSE_symbolic_functions_over_training[0:1000100:100]).rolling(100).mean(),
               label=r"$\mathcal{L}_{PDE}$", linewidth=1.5,
               alpha=1.0, color="C3")
axs[1, 1].plot(training_steps, pd.Series(Relative_L2_Error_h_over_training[0:1000100:100]).rolling(100).mean(),
               label=r"$\mathcal{L}_{num,\zeta}$", linewidth=1.5,
               alpha=1.0, color="C4")
axs[1, 1].plot(training_steps, pd.Series(Relative_L2_Error_u_over_training[0:1000100:100]).rolling(100).mean(),
               label=r"$\mathcal{L}_{num,u}$", linewidth=1.5,
               alpha=1.0, color="C5")
...
lgd = axs[1, 1].legend(labels, loc='center', bbox_to_anchor=(0.509, 0.03), ncol=len(labels),
                 bbox_transform=fig.transFigure, frameon=False)

plt.savefig("TIFF/Fig8.tiff", bbox_extra_artists=(lgd, ), dpi=95)
plt.show()
