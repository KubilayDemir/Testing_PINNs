...
axs[0, 0].plot(0.001 * x, true_initial_condition_h_values, "-", label=r"$\zeta_{NUM}$", linewidth=2)
axs[0, 0].plot(0.001 * x, network_output_h_initial_conditions, "--", label=r"$\zeta_{NN}$", linewidth=2)
axs[0, 0].set_xlabel("x [km]")
axs[0, 0].set_title(r"$\zeta(t=0,x)$")
leg = axs[0, 0].legend()
axs[0, 0].grid()
...
axs[0, 1].plot(0.001 * x, true_initial_condition_h_values, "-", label=r"$\zeta_{NUM}$", linewidth=2)
axs[0, 1].plot(0.001 * x, network_output_h_initial_conditions, "--", label=r"$\zeta_{NN}$", linewidth=2)
axs[0, 1].set_xlabel("x [km]")
axs[0, 1].set_title(r"$\zeta(t=0,x)$")
leg = axs[0, 1].legend()
axs[0, 1].grid()
for legobj in leg.legendHandles:
    legobj.set_linewidth(3.0)
...
axs[1, 0].plot(0.001 * x, true_initial_condition_h_values, "-", label=r"$\zeta_{NUM}$", linewidth=2)
axs[1, 0].plot(0.001 * x, network_output_h_initial_conditions, "--", label=r"$\zeta_{NN}$", linewidth=2)
axs[1, 0].set_xlabel("x [km]")
axs[1, 0].set_title(r"$\zeta(t=0,x)$")
leg = axs[1, 0].legend()
axs[1, 0].grid()
for legobj in leg.legendHandles:
    legobj.set_linewidth(3.0)
...
axs[1, 1].plot(0.001 * x, true_initial_condition_h_values, "-", label=r"$\zeta_{NUM}$", linewidth=2)
axs[1, 1].plot(0.001 * x, network_output_h_initial_conditions, "--", label=r"$\zeta_{NN}$", linewidth=2)
axs[1, 1].set_xlabel("x [km]")
axs[1, 1].set_title(r"$\zeta(t=0,x)$")
leg = axs[1, 1].legend()
axs[1, 1].grid()
for legobj in leg.legendHandles:
    legobj.set_linewidth(3.0)
