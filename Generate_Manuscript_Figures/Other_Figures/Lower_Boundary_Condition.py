...
axs[0, 0].plot(t / 60. / 60., network_output_u_lower_boundary_condition, "-", label=r"$u_{NN}$")
axs[0, 0].plot(t / 60. / 60., true_lower_boundary_condition_u_values, "-", label=r"$u_{NUM}$")
...
axs[0, 1].plot(t / 60. / 60., network_output_u_lower_boundary_condition, "-", label=r"$u_{NN}$")
axs[0, 1].plot(t / 60. / 60., true_lower_boundary_condition_u_values, "-", label=r"$u_{NUM}$")
...
axs[1, 0].plot(t / 60. / 60., network_output_u_lower_boundary_condition, "-", label=r"$u_{NN}$")
axs[1, 0].plot(t / 60. / 60., true_lower_boundary_condition_u_values, "-", label=r"$u_{NUM}$")
...
axs[1, 1].plot(t / 60. / 60., network_output_u_lower_boundary_condition, "-", label=r"$u_{NN}$")
axs[1, 1].plot(t / 60. / 60., true_lower_boundary_condition_u_values, "-", label=r"$u_{NUM}$")
