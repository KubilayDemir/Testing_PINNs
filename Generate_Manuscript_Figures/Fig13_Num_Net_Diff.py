...
data_directory = "Train_On_Validation_Loss/AH=5e+4/"
...
im02 = axs[0, 2].imshow(np.flipud(abs_error_h_values), cmap=difference_colormap, aspect='auto',
                        extent=[0, 75, -1000, 1000], vmin=0.000, vmax=0.006)
...
im12 = axs[1, 2].imshow(np.flipud(abs_error_u_values), cmap=difference_colormap, aspect='auto',
                        extent=[0, 75, -1000, 1000], vmin=0.000, vmax=0.003)
...
plt.savefig("TIFF/Fig13.tiff", dpi=95)
# plt.show()
