...
zeta3 = np.load("Examples/dx=80m_dt=1s/Sea_Level_Elevation.npy")[:-1, 63::125]
u3 = np.load("Examples/dx=80m_dt=1s/Zonal_Velocity.npy")[:-1, ::125]

zeta2 = np.load("Examples/dx=400m_dt=1s/Sea_Level_Elevation.npy")[:-1, 13::25]
u2 = np.load("Examples/dx=400m_dt=1s/Zonal_Velocity.npy")[:-1, ::25]

zeta1 = np.load("Examples/dx=2km_dt=1s/Sea_Level_Elevation.npy")[:-1, 3::5]
u1 = np.load("Examples/dx=2km_dt=1s/Zonal_Velocity.npy")[:-1, ::5]

zeta0 = np.load("Examples/dx=10km_dt=1s/Sea_Level_Elevation.npy")[:-1, 1:-1]
u0 = np.load("Examples/dx=10km_dt=1s/Zonal_Velocity.npy")[:-1, :-1]
