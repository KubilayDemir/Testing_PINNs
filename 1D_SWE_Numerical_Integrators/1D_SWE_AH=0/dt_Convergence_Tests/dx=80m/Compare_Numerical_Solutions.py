...
zeta2 = np.load("Examples/dx=80m_dt=1s/Sea_Level_Elevation.npy")[:-1, 63::125]
u2 = np.load("Examples/dx=80m_dt=1s/Zonal_Velocity.npy")[:-1, ::125]

zeta1 = np.load("Examples/dx=80m_dt=2s/Sea_Level_Elevation.npy")[:-1, 63::125]
u1 = np.load("Examples/dx=80m_dt=2s/Zonal_Velocity.npy")[:-1, ::125]

zeta0 = np.load("Examples/dx=80m_dt=5s/Sea_Level_Elevation.npy")[:-1, 63::125]
u0 = np.load("Examples/dx=80m_dt=5s/Zonal_Velocity.npy")[:-1, ::125]
