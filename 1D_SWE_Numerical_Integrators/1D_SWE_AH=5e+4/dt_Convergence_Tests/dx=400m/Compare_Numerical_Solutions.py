...
zeta1 = np.load("Examples/dx=400m_dt=1s/Sea_Level_Elevation.npy")[:-1, 13::25]
u1 = np.load("Examples/dx=400m_dt=1s/Zonal_Velocity.npy")[:-1, ::25]

zeta0 = np.load("Examples/dx=400m_dt=1s/Sea_Level_Elevation.npy")[:-1, 13::25]
u0 = np.load("Examples/dx=400m_dt=1s/Zonal_Velocity.npy")[:-1, ::25]
