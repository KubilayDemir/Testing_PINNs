...
zeta3\
    = np.load("Examples/dx=2km_dt=1s/Sea_Level_Elevation.npy")[:-1, 3::5]
u3 = np.load("Examples/dx=2km_dt=1s/Zonal_Velocity.npy")[:-1, ::5]

zeta2 = np.load("Examples/dx=2km_dt=5s/Sea_Level_Elevation.npy")[:-1, 3::5]
u2 = np.load("Examples/dx=2km_dt=5s/Zonal_Velocity.npy")[:-1, ::5]

zeta1 = np.load("Examples/dx=2km_dt=10s/Sea_Level_Elevation.npy")[:-1, 3::5]
u1 = np.load("Examples/dx=2km_dt=10s/Zonal_Velocity.npy")[:-1, ::5]

zeta0 = np.load("Examples/dx=2km_dt=30s/Sea_Level_Elevation.npy")[:-1, 3::5]
u0 = np.load("Examples/dx=2km_dt=30s/Zonal_Velocity.npy")[:-1, ::5]
