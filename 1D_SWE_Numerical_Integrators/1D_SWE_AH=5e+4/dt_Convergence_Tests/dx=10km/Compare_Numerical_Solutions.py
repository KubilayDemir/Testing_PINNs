...
zeta4 = np.load("Examples/dx=10km_dt=1s/Sea_Level_Elevation.npy")[:-1, 1:-1]
u4 = np.load("Examples/dx=10km_dt=1s/Zonal_Velocity.npy")[:-1, :-1]

zeta3 = np.load("Examples/dx=10km_dt=5s/Sea_Level_Elevation.npy")[:-1, 1:-1]
u3 = np.load("Examples/dx=10km_dt=5s/Zonal_Velocity.npy")[:-1, :-1]

zeta2 = np.load("Examples/dx=10km_dt=10s/Sea_Level_Elevation.npy")[:-1, 1:-1]
u2 = np.load("Examples/dx=10km_dt=10s/Zonal_Velocity.npy")[:-1, :-1]

zeta1 = np.load("Examples/dx=10km_dt=30s/Sea_Level_Elevation.npy")[:-1, 1:-1]
u1 = np.load("Examples/dx=10km_dt=30s/Zonal_Velocity.npy")[:-1, :-1]

zeta0 = np.load("Examples/dx=10km_dt=60s/Sea_Level_Elevation.npy")[:-1, 1:-1]
u0 = np.load("Examples/dx=10km_dt=60s/Zonal_Velocity.npy")[:-1, :-1]
